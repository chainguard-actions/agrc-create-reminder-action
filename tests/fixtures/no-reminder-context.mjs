// Fixture: issue comment context with no /remind command
// Used by the action's testContextPath input for testing.
// Uses named exports so that dynamic import() returns an object matching
// the IssueCommentCreatedOrEditedEvent structure directly.
